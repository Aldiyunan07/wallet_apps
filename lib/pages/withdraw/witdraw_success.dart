...
class WithdrawSuccess extends StatefulWidget {
  ...
  const WithdrawSuccess({Key? key, required this.transactionId}) : super(key: key);
...
class _WithdrawSuccessState extends State<WithdrawSuccess> {
  late Future<Map<String, dynamic>> futureWithdrawData;

  @override
  void initState() {
    super.initState();
    futureWithdrawData = fetchWithdrawData(widget.transactionId);
  }

  Future<Map<String, dynamic>> fetchWithdrawData(int id) async {
